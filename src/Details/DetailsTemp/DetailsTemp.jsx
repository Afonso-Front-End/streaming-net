...
import { ModallTemporada, ListaTemporada, SelectTemporada, SelectButtonTemporada, Dropdown, DropdownButtonItem } from "../DetailsStyle/DetailsStyle"
const DetailsTemp = ({ mediaCurrent, onTemporadaSelect, newMediaCurrent }) => {
